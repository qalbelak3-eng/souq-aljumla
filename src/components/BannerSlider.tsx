...
export default function BannerSlider({ 
  ...
  return (
    ...
    >
      ...
      {position === 'top' && (
        <div className="absolute top-[calc(80px+clamp(0px,calc(env(safe-area-inset-top,0px)-30px),20px))] sm:top-[60px] md:top-[64px] left-0 right-0 z-20 pointer-events-none">
          <div className="w-full max-w-5xl mx-auto px-4 sm:px-6">
            <form onSubmit={handleSearch} className="relative w-full pointer-events-auto">
              <input
                type="text"
