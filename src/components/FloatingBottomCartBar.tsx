...
export default function FloatingBottomCartBar() {
  ...
  return (
    <div className="fixed bottom-[calc(66px+env(safe-area-inset-bottom,0px))] sm:bottom-[calc(72px+env(safe-area-inset-bottom,0px))] inset-x-3 sm:inset-x-6 max-w-lg mx-auto z-30 select-none print:hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
