...
export default function WhatsAppFloatingButton() {
  ...
  return (
    ...
    <button
      ...
      className="fixed bottom-[calc(76px+env(safe-area-inset-bottom,0px))] left-5 sm:bottom-[calc(80px+env(safe-area-inset-bottom,0px))] sm:left-7 z-50 w-14 h-14 sm:w-16 sm:h-16 bg-[#ef533a] hover:bg-[#e0452c] active:scale-95 text-white rounded-full shadow-[0_8px_25px_rgba(239,83,58,0.45)] flex items-center justify-center transition-all duration-300 transform hover:scale-105 border-2 border-white/20 print:hidden"
